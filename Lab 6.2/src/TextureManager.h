...
public:
	...
	void Draw(const std::string& id, const SDL_Rect src, const SDL_FRect dst);
	...
	void DrawText(const std::string& id, glm::vec2 position, double angle, int alpha, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);	// animation functions
